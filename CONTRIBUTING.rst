Contribute to pytest-repeater
=============================

Thank you for taking time to contribute to pytest-repeater!

The following is a set of guidelines for contributing to pytest-repeater .These are just guidelines, not rules, use your best judgment and feel free to propose changes to this document in a pull request.
...
#. Additional, not always mandatory checks are being performed by `QuantifiedCode <https://www.quantifiedcode.com/app/project/gh:ClearcodeHQ:pytest-repeater>`_
